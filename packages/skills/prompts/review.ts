...
export function reviewInstructions(language = "en"): string {
  return (
    [
      ...
      "4. If Documentation is available, compare docs description with actual implementation:",
      "   - **Docs outdated**: Documentation describes behavior not present in the implementation",
      "",
      "## Report Format",
      "",
      "For each difference found:",
      "```",
      "- [L3/L1/cosmetic/docs] <description>",
