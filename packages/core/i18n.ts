...
const messages: Record<string, Record<string, string>> = {
  en: {
    ...
    "cli.init.nextGuideHeader": "What to do next:",
    "cli.init.nextGuideStep1":
      '  1. Describe your project\n     Edit .svp/l5.json — add intent, domains, constraints\n     Or ask your AI: "help me design the L5 blueprint"',
    "cli.init.nextGuideStep2": "  2. Open your AI assistant and run:\n     {command}",
    "cli.init.nextGuideStep3":
      "  3. The workflow will guide you through:\n     Build / Add / Change / Fix / View",
    "cli.init.promptIntent": "What does this project do? (press Enter to skip)",
    "cli.init.promptHostSelect": "Multiple hosts detected. Which one?",
    "cli.init.promptHostAll": "All",
    "cli.init.promptHostSkip": "Skip",
    "cli.init.slashCommands": "{host}: {count} skill files → {skillDir}/",
    "cli.init.skillUpToDate": "{host}: skill files up to date (v{version})",
    "cli.init.skillUpdated": "{host}: skill files updated ({oldVersion} → {newVersion})",
    "cli.init.skillUpdatedLegacy": "{host}: skill files updated",
  ...
  zh: {
    ...
    "cli.init.nextGuideHeader": "接下来做什么：",
    "cli.init.nextGuideStep1":
      '  1. 描述你的项目\n     编辑 .svp/l5.json — 添加意图、领域、约束\n     或者让 AI 帮忙: "help me design the L5 blueprint"',
    "cli.init.nextGuideStep2": "  2. 打开你的 AI 助手并运行：\n     {command}",
    "cli.init.nextGuideStep3": "  3. 工作流将引导你完成：\n     构建 / 添加 / 修改 / 修复 / 查看",
    "cli.init.promptIntent": "这个项目做什么？（按 Enter 跳过）",
    "cli.init.promptHostSelect": "检测到多个宿主。选择哪一个？",
    "cli.init.promptHostAll": "全部",
    "cli.init.promptHostSkip": "跳过",
    "cli.init.slashCommands": "{host}: {count} 个 skill 文件 → {skillDir}/",
    "cli.init.skillUpToDate": "{host}: skill 文件已是最新 (v{version})",
    "cli.init.skillUpdated": "{host}: skill 文件已更新 ({oldVersion} → {newVersion})",
    "cli.init.skillUpdatedLegacy": "{host}: skill 文件已更新",
